...
create function start_url_generation(source_ varchar(256), start_state_ varchar(256), process_name_ varchar(256))
returns bigint as $$
    insert into url_generation (source, start_state, process_name)
    values (source_, start_state_, process_name_)
    returning id;
$$ language sql;
...
create function stop_url_generation(url_generation_id_ bigint, stop_state_ varchar(256), n_urls_ int)
returns void as $$
