...
from aggregator.structured.medicine import StructuredEtlMedicine
from aggregator.structured.naviny import StructuredEtlNaviny
from aggregator.structured.tutby import StructuredEtlTutby
