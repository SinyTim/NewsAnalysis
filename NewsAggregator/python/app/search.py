...
def get_data():
    ...
    path_articles = Path(r'C:\Users\Tim\Documents\GitHub\NewsAnalysis\data\_data\dw\documents_data')
    ...
    articles = read_dir_parquet(path_articles)
    embeddings = read_dir_parquet(path_embeddings)
